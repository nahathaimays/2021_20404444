...
set OLD_PATH=%PATH%
set PATH=C:\Program Files\CMake\bin;C:\Qt\6.2.2\msvc2019_64\bin
...
cmake -DCMAKE_PREFIX_PATH=C:\Qt\6.2.2\msvc2019_64\bin -G"Visual Studio 16 2019" %1

REM Restore old path (otherwise vcvarsall will fail) but make sure Qt bin dir has been added to it
set PATH=%OLD_PATH%;C:\Qt\6.2.2\msvc2019_64\bin
